...
delete from public.sme_development_programs where name like 'NTDP Demo SME Programme %';
...
-- Destination and province rows are intentionally NOT removed here because they contain
-- real PNG tourism reference data and may be used by non-demo records.
