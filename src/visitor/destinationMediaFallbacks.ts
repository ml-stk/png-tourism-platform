...
export const destinationMediaFallbacks: Record<string, DestinationFallbackMedia> = {
  ...
  'bomana-war-cemetery': { url: commons('View of Nine-Mile Quarry from Bomana War Cemetery near Port Moresby.jpg'), altText: 'View from Bomana War Cemetery near Port Moresby', credit: 'Wikimedia Commons — Arthur Chapman, CC BY 2.0' },
