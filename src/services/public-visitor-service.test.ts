...
const destination = (publicationStatus: Destination['publicationStatus']): Destination => ({ id: 'd1', name: 'Kokopo', slug: 'kokopo', provinceCode: 'EAST_NEW_BRITAIN', publicationStatus, contentVersion: 1, updatedAt: new Date().toISOString() });
const content = (publicationStatus: ContentItem['publicationStatus']): ContentItem => ({ id: 'c1', type: 'experience', title: 'Reef', slug: 'reef', publicationStatus, version: 1, updatedAt: new Date().toISOString(), provinceCode: 'EAST_NEW_BRITAIN' });
